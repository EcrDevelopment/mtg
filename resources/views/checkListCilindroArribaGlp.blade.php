                ...
                <td style="width: 50%;">
                    <table style="border: 1px solid; border-collapse: collapse; width:100%;">
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid; border-collapse: collapse;">
                                Su ubicación debe ser según las especificaciones del fabricant.
                            </td>
                            <td style="border: 1px solid; border-collapse: collapse;text-align: center;">
                                C
                            </td>
                        ...
                        <tr>
                            <td style="border: 1px solid; border-collapse: collapse;">
                                La corriente para su accionamiento debe ser tomada de la posición de la chapa de
                                encendido
                            </td>
                            <td style="border: 1px solid; border-collapse: collapse;text-align: center;">
                                C
                        ...
                        <tr>
                            <td style="border: 1px solid; border-collapse: collapse;">
                                Entre este y la forma de alimentación eléctrica se debe intercalar un fusible para
                                proteger todo el sistema eléctrico del equipo de conversión
                            </td>
                            <td style="border: 1px solid; border-collapse: collapse;text-align: center;">
                                C
                            </td>
                        ...
                        <tr>
                            <td style="border: 1px solid; border-collapse: collapse;">
                                Dispone de un sistema de fijación propio de modo que su peso no sea soportado por las
                                líneas rígidas o ﬂexibles adyacentes
                            </td>
                            <td style="border: 1px solid; border-collapse: collapse;text-align: center;">
                                C
                            </td>
                        ...
                        <tr>
                            <td style="border: 1px solid; border-collapse: collapse;">
                                Colocado de manera que el desplazamiento y el movimiento del vehículo no afectan el
                        ...
                        <tr>
                            <td style="border: 1px solid; border-collapse: collapse;">
                                Conexiones eléctricas y conectores, deben estar protegidos, mediante dispositivos,
                                contra eventuales cortocircuitos y contra la corrosión
                            </td>
                            <td style="border: 1px solid; border-collapse: collapse;text-align: center;">
                                C
                            </td>
                        ...
                        <tr>
                            <td style="border: 1px solid; border-collapse: collapse;">
                                En todos los terminales se debe utilizar elementos para aislamiento eléctrico o
                                conectores aislados
                            </td>
                            <td style="border: 1px solid; border-collapse: collapse;text-align: center;">
                                C
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid; border-collapse: collapse;">
                                Realizado el montaje del equipo completo, se efectuará una veriﬁcación por prueba
                                neumática empleando aire comprimido o un gas inerte hasta la salida del regulador,
                                con el ﬁn de comprobar si existen fugas a través de las conexiones en el tramo de alta
                                presión
                            </td>
                            <td style="border: 1px solid; border-collapse: collapse;text-align: center;">
                                C
                        ...
                        <tr>
                            <td style="border: 1px solid; border-collapse: collapse;">
                                En el tramo de baja presión se realizará la veriﬁcación al doble de la presión
                                reguladora
                            </td>
                            <td style="border: 1px solid; border-collapse: collapse;text-align: center;">
                                C
