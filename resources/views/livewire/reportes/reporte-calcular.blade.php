<div>
    <div class="sm:px-6 w-full pt-12 pb-4">
        ...
        @if (isset($reportePorInspector))
            ...
            <div wire.model="resultados">
                ...
                @foreach ($reportePorInspector as $inspector => $certificacionesInspector)
                    <div class="bg-gray-200  px-8 py-4 rounded-xl w-full mt-4">
                        <div class="p-2 w-full justify-between m-auto flex items-space-around">
                            ...
                            <button wire:click="ver({{ json_encode(collect($certificacionesInspector)->pluck('id')->toArray()) }}, {{ json_encode(collect($certificacionesInspector)->pluck('tiposervicio')->unique()->toArray()) }})"
    ...
    <script>
        // Escuchar el evento y refrescar la tabla
