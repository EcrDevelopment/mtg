    ...
    <main>
        ...
        <p>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">{{$carro->pesoNeto+0}}</td>
                </tr>
                <tr>
           ...
           <ol type="1" style="font-size:7px;">
                ...
                <li>
                    El vaporizador/regulador cuenta con un sistema de corte de gas automático, en el caso que el motor deje de funcionar.
                </li>
                <li>
                    El tanque de almacenamiento de GLP ha sido fabricado bajo normas ASME Sección VIII y cumple las normas dictadas para recipientes a presión.
                </li>
                <li>
                ...
                <li>
                    Los accesorios e insumos (mangueras, tuberías y válvulas) utilizados en la instalación han sido certificados para el uso de GLP.
                </li>
                <li>
                    No existan fugas en los empalmes o uniones y los elementos de cierre actúan herméticamente.
                </li>
                <li>
                    Los controles ubicados en el tablero del vehículo responden a las exigencias para los cuales fueron montados.
                </li>
           </ol>
        ...
        <p style="font-size:9px;">
            Conste por el  presente  documento  que  el  sistema  de   combustión a Gas Licuado de Petróleo-GLP  del
             ...
             el medio  ambiente o incumple con las condiciones técnicas establecidas en la normativa vigente en la materia,
             según consta en el expediente técnico <strong>N° SD-30- {{$numHoja}}</strong>,  habilitándose al mismo tiempo para cargar Gas
