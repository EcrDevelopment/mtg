...
<body>
    ...
    <main>
        ...
        <p>Habiéndose verificado que:</p>
            <ol type="1">
                <li>El sistema de combustión a GLP (cilindro y kit de conversión) responde a las características originales recomendadas por el fabricante del vehículo  y/o  el Proveedor de Equipos Completos de Conversión a  GLP  (PEC-GLP),  cumple con la Norma Técnica Peruana NTP 321.115:2003 y su montaje cumple las exigencias sobre la ventilación en las distintas zonas de instalación.</li>
                <li>El vaporizador/regulador cuenta con un sistema de corte de gas automático, en el caso que el motor deje de funcionar.</li>
                <li>El tanque de almacenamiento de GLP ha sido fabricado bajo normas ASME Sección VIII y cumple las normas dictadas para recipientes a presión, asimismo, cuenta con una válvula check en la entrada de gas, un limitador automático de carga al 80%, una válvula de exceso de presión y una válvula de exceso de flujo</li>
                <li>Los accesorios e insumos (mangueras, tuberías y válvulas) utilizados en la instalación han sido certificados para el uso de GLP y están instalados de manera segura.</li>
                <li>Los equipos y accesorios utilizados en la modificación para uso de GLP cumplen con la Norma Técnica Peruana NTP 321.115:2003.</li>
                <li>No existan fugas en los empalmes o uniones y los elementos de cierre actúan herméticamente.</li>
                <li>Los controles ubicados en el tablero del vehículo responden a las exigencias para los cuales fueron montados.</li>
            </ol>
        <p>
            ...
            Gas Licuado de Petróleo - GLP, del vehículo antes referido, no afectaran negativamente
             ...
             en  el expediente  técnico  N°  SD-30- {{$numHoja}}
        </p>
        <p>
           Habilitandose al mismo para cargar Gas Licuado de Petróleo-GLP hasta el día: {{$fechaCert->format("d/m/").($fechaCert->format("Y")+1)}}
        </p>

        <p>
            El presente Certificado es emitido a solicitud del Taller de Conversión a GLP autorizado: <strong>{{$taller->nombre}}</strong>
        </p>
        <h6>OBSERVACIONES</h6>
        <ol type="1" >
            <li>
